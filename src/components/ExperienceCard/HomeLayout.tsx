...
export const HomeLayout: React.FC<SharedExperienceCardProps> = ({
  ...
  const {
    ...
    return (
    <div
      className="relative w-full aspect-[3/5] gap-[var(--spacing-1200)] rounded-800 p-[var(--spacing-800)] transition-transform transform hover:scale-[1.01] hover:shadow-elevation-1 cursor-pointer overflow-hidden flex flex-col"
