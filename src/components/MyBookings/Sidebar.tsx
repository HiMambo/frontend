...
export default function Sidebar({ selectedSection, setSelectedSection }: SidebarProps) {
  return (
    <aside className="fixed top-0 left-0 h-full w-64 bg-white shadow-md p-6 overflow-y-auto flex flex-col">
      <div>
        <div className="mb-8 flex items-center space-x-4">
          <img src="/logo.png" alt="HiMambo Logo" className="w-10 h-10" />
          <a href="/" className="px-4 py-1.5 text-lg font-semibold text-orange-400 bg-orange-100 hover:bg-orange-200 rounded-lg transition-colors">
            Home
          </a>
        </div>
